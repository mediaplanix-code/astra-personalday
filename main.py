...
from routers import auth, profiles, horoscope, luna, webhooks, admin, scheduler, telegram, clienti
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://astra-personal.pages.dev",
        "https://bd5e157d.astra-personal.pages.dev",
        "http://localhost:3000",
        "http://localhost:8080",
    ],
...
# JWT verificato su ogni richiesta (route pubbliche escluse)
app.add_middleware(SupabaseAuthMiddleware)

# Route protette da JWT Supabase (vecchio sistema — manteniamo per retrocompatibilità)
...
# Nuovo sistema clienti — nessuna auth JWT richiesta
